...
import 'package:easysugar/view/screens/authentication/regestration_screen.dart';
...
import 'package:easysugar/view/screens/report_screen.dart';
  ...
  Route? generateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case RoutsNames.follwarScreen:
        return MaterialPageRoute(builder: (_) => FollowerScreen());
